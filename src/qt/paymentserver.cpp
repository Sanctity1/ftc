...
const QString BITCOIN_IPC_PREFIX("ftc:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ftc: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ftc: click-to-pay handler");
    else
...
{
    // clicking on ftc: URLs creates FileOpen events on the Mac:
