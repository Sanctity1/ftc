...
#if defined(NDEBUG)
# error "ftc cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ftc Signed Message:\n";
...
{
    int64_t nSubsidy = (50000000 * COIN)/Params().LastPOWBlock();
...
//    const double stakes[] = {50000000,60000000,96000000,102400000,143360000,100352000,120422400,108380160,124637184,47777587};
//    const double reward[] = {47.565,38.052,45.662,38.965,45.459,27.275,28.639,22.911,23.713,8.264};
    const double rate[] = {100,60,60,40,40,20,20,15,15,5};
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal ftc miner
...
#ifdef ENABLE_WALLET
// ftc: attempt to generate suitable proof-of-stake
